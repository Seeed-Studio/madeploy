...
PointDetector::PointDetector(Engine* p_engine, const char* name, ma_model_type_t type) : Model(p_engine, name, MA_MODEL_INPUT_TYPE_IMAGE | MA_MODEL_TASK_KEYPOINT | type) {
